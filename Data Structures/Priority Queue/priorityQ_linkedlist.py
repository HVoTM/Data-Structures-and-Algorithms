# Python3 code to implement Priority Queue using Singly Linked List

# Class to create new node which includes Node Data, and Node Priority
...
class PriorityQueue:
	...
	# Method to check Priority Queue is Empty or not if Empty then it will return True
	# Otherwise False
	def isEmpty(self):
	...
	def pop(self):
		...
		if self.isEmpty() == True:
			...
			# Removing high priority node from Priority Queue
            # ,and updating front with next node
...
if __name__ == "_main_":
	...
	# Removing highest Priority item for priority queue
	pq.pop()
